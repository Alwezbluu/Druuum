...
from GenreClass.transformer.audio_processing import random_crop, random_mask


class DataGenerator(TimeseriesGenerator):
...
class PretrainGenerator(TimeseriesGenerator):
...
if __name__ == "__main__":
    in_path = "D:/Downloads/fma_metadata/tracks.csv"
    genres_path = "D:/Downloads/fma_metadata/genres.csv"

    out_path = "D:/Downloads/fma_metadata/tracks_genre.json"
    mapping_path = "D:/Downloads/fma_metadata/mapping.json"

    df = load("D:/Downloads/fma_metadata/tracks.csv")
